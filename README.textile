...
p.  Currently, there are a few tests (<a href="easyb">http://www.easyb.org/</a> BDD). These should be readable enough to 
...
p.   Annotate the domain object with @MongoMapped together with the name of the collection, <b>users</b> in this case. Note that
